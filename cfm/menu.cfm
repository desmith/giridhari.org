...
<br>
 <table width="75%" border="0" cellspacing="2" cellpadding="2" align="center">
    <tr align="center" valign="middle"> 
      <td><font face="Comic Sans MS" size="2"><cfoutput query="alldates"><a href="menu.cfm?progid=#alldates.progID#">#DateFormat(alldates.PDate,'m/d/yy')#</a> &nbsp;|&nbsp;</cfoutput></font></td>
    </tr>
  </table>
<div align="center"> 
...
<cfset bookselect = #preps.source#&#preps.prepid#>
	<tr valign="top">
		<td align="center"><cf_preps preptype=#preps.type# prepfld=#prepselect#></td>
